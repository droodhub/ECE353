...
{
    //set slave addr to be 7b
    //EUSCI_B1->CTLW0 &= ~EUSCI_B_CTLW0_SLA10;

    //load 12CSA reg with slave_address
...
{
    //Send start condition, will be automatically cleared
